...
const ElectricsPage = () => {
    ...
    return <>
        <main className="w-full">
            <img src="/images/electronics/Electrics-Show-Room1.png" alt="image" className="w-full h-auto" />
            ...
            <img src="/images/electronics/Home-Appliances.png" alt="image" className="w-full h-auto" />
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-start items-start gap-6 px-4 lg:px-8 py-5">
            ...
            <div className="flex justify-start items-start w-full px-4 gap-6 lg:px-8 py-5">
                <div className="w-auto hidden lg:block">
                    <img src="/images/electronics/LIGHT.png" alt="image" className="w-full h-auto" />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full px-4 gap-6 lg:px-8 py-5">
                <img src="/images/electronics/Lighting.png" alt="image" className="w-full" />
                <img src="/images/electronics/Lighting1.png" alt="image" className="w-full" />
            </div>
            <div className="flex justify-start items-start w-full px-4 gap-6 lg:px-8 py-5">
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="w-auto hidden lg:block">
                    <img src="/images/electronics/Smart-Home.png" alt="image" className="w-full h-auto" />
                </div>
            </div>
        </main>
    </>
